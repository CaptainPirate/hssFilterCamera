...
public class RotatableLayout extends FrameLayout {
    ...
    public void onAttachedToWindow() {
        ...
        if (mPrevRotation == UNKOWN_ORIENTATION) {
            mIsDefaultToPortrait = true;//CameraUtil.isDefaultToPortrait((Activity) getContext());
    ...
    private void rotateIfNeeded() {
        ...
        int rotation = 0;//CameraUtil.getDisplayRotation((Activity) getContext());
    ...
    public void checkLayoutFlip() {
        int currentRotation = 0;//CameraUtil.getDisplayRotation((Activity) getContext());
